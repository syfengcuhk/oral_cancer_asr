...
expdir=exp_for_kaldi/GMM_HMM_training_no_merge_wsj_deltas_${deltas_leaves}_${deltas_gausses}_lda_${lda_mllt_leaves}_${lda_mllt_gausses}_sat_${sat_leaves}_${sat_gausses}${expdir_suffix}/${fold_id}${fold_affix}/
